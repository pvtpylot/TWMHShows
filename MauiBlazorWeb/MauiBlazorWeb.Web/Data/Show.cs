...
public class Show : BaseEntity
{
    ...
    [Required] public DateTime ShowDate { get; set; }

    public DateTime? EndDate { get; set; }

    [Required] public ShowStatus Status { get; set; } = ShowStatus.Upcoming;
    ...
    [ForeignKey("ShowHolderId")] public UserModelObject? ShowHolder { get; set; }

    // Show type and format
    [Required] public ShowType ShowType { get; set; } = ShowType.LiveShow;

    [Required] public ShowFormat ShowFormat { get; set; } = ShowFormat.Regular;
