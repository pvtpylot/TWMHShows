...
public class LiveComment : BaseEntity
{
    ...
    [ForeignKey("AuthorId")] public virtual ApplicationUser? Author { get; set; }

    // Live show relationship
    public int LiveShowId { get; set; }

    [ForeignKey("LiveShowId")] public virtual LiveShow LiveShow { get; set; } = null!;

    // Class-specific comments
    public int? ShowClassId { get; set; }

    [ForeignKey("ShowClassId")] public virtual ShowClass? ShowClass { get; set; }
}
