...
using IHttpClientFactory = MauiBlazorWeb.Services.IHttpClientFactory;

// REQUIRED for AddHttpClient
    ...
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddAuthorizationCore(options =>
        {
            ...
            options.AddPolicy("RequireUserRole",
                policy => policy.RequireRole(ApplicationRoles.User, ApplicationRoles.TrialUser,
